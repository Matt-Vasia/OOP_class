...
void menu(Vector <duom> &grupe)
{
    ...
    else if (rule=='5')
    {
        ...
        print_data_to_file(grupe, 5, test_file_location + "kursiokai_1000.dat");
        ...
        print_data_to_file(grupe, 5, test_file_location + "kursiokai_10000.dat");
        ...
        print_data_to_file(grupe, 5, test_file_location + "kursiokai_100000.dat");
        end = std::chrono::high_resolution_clock::now();
        ...
        print_data_to_file(grupe, 5, test_file_location + "kursiokai_1000000.dat");
        end = std::chrono::high_resolution_clock::now();
        ...
        print_data_to_file(grupe, 5, test_file_location + "kursiokai_10000000.dat");
        end = std::chrono::high_resolution_clock::now();
...
void sorting(Vector <duom> &grupe, char rule)
{
    ...
    if(rule=='1')
        std::stable_sort( grupe.begin(), grupe.end(), [](const duom& a, const duom& b){return compare(a.getVar(), b.getVar(), "Vardas");});
    else if(rule=='2')
        std::stable_sort( grupe.begin(), grupe.end(), [](const duom& a, const duom& b){return compare(a.getPav(), b.getPav(), "Vardas");});
    else if(rule=='3')
        std::stable_sort( grupe.begin(), grupe.end(), [](const duom& a, const duom& b){return a.getMark() > b.getMark();});
}
